...
class PipelineConfig(BaseModel):
    ...
    summarizer_backend_engine: Optional[str] = Field(default=None, description="Backend engine for summarization")
    summarizer_backend_model: Optional[str] = Field(default=None, description="Backend model for summarization")
    summarizer_backend_gpu: Optional[str] = Field(default=None, description="GPU device ID for summarizer backend")
    ...
    text_structurer_backend_engine: Optional[str] = Field(default=None, description="Backend engine for text structurer")
    text_structurer_backend_model: Optional[str] = Field(default=None, description="Backend model for text structurer")
    text_structurer_backend_gpu: Optional[str] = Field(default=None, description="GPU device ID for text structurer backend")
    slide_translator_url: Optional[str] = Field(default=None, description="External backend URL for slide translator")
    slide_translator_engine: Optional[str] = Field(default=None, description="Backend engine for slide translator")
    slide_translator_model: Optional[str] = Field(default=None, description="Backend model for slide translator")
    slide_translator_gpu: Optional[str] = Field(default=None, description="GPU device ID for slide translator backend")
