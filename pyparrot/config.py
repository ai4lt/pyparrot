...
class PipelineConfig(BaseModel):
    ...
    asr_backend_engine: str = Field(default="faster-whisper", description="ASR backend engine (faster-whisper) for local/distributed modes")
    asr_backend_model: str = Field(default="large-v2", description="ASR model (large-v2) for local/distributed modes")
    asr_backend_gpu: Optional[str] = Field(default=None, description="GPU device ID for ASR backend (e.g., '0', '1', or None for CPU)")
